...
class User extends MY_Controller {
    ...
    function __construct() {
        parent::__construct();
        $this->load->library(array('myuser', 'myvalidation'));
    ...
    private function post_data(){
       return $data = array(
            ...
            'user_category' => htmlspecialchars(trim($this->input->post('user_category', TRUE))),
            'subscribed' => htmlspecialchars(trim($this->input->post('subscribed', TRUE))),
    ...
    /**
    * Allows Author to change their passwords
    */
