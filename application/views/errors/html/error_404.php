...
<html>
	<head>
		<title>Quizyclopdia: Page not found</title>
		<style>
						html {
...
<div class="text">
  <div class="text-inner">
    <h1> WETIN YOU DEY FIND?. </h1>

    <h2> The Page you are looking for is not HERE please! </h2>

    <div id="home" class="button">
        <h3>PLEASE STICK TO SITE NAVIGATION PROCESS</h3>
    </div>
	</div>
